              ...
              <UserMenu>
                <UserIcon>
                  ...
                  <UserDropdown>
                    ...
                    <DropdownLink to="/cart">🛒 My Orders</DropdownLink>
                    {userRole === 'seller' && (
                      <DropdownLink to="/seller-dashboard">📊 Seller Dashboard</DropdownLink>
                    )}
                    {userRole === 'admin' && (
                      <DropdownLink to="/admin-dashboard">⚙️ Admin Panel</DropdownLink>
                    )}
                    <DropdownDivider />
